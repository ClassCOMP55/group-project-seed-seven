...
public class GameplayPane extends GraphicsPane {
    ...
    private void addEnemy() {
        ...
        int markerSize = (currentStage == 4) ? 42 : 24;
        enemyMarker = new GOval(enemyX + 3, enemyY + 3, markerSize, markerSize);
        ...
        if (type == EnemyType.SPIDER) {
            ...
            enemyMarker.setFillColor(Color.MAGENTA);
        }
            ...
            while (gameLoopStarted && currentLoopVersion == loopVersion) {
                ...
                if (enemy != null && enemyMarker != null) {
                    if (enemy.getParent() != null) {
                        enemyMarker.setLocation(enemy.getX() + 3, enemy.getY() + 3);
                        enemyMarker.sendToFront();
                    } else {
                        if (enemyMarker.getParent() != null) {
